...
function NewApiSection(props) {
  ...
  const [ui, setUi] = (0, import_react2.useState)({ undoMs: 7e3, undoEnabled: true });
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "newapi-panel", children: [
        ...
        instances.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "newapi-empty", children: t("noInstances") }) : activeDraft === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          InstanceEditor,
          {
            ...
            onRequestRemove: () => {
              setConfirmRemoveIndex(safeActiveIndex);
            },
            notify: pushToast,
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { className: "newapi-modal-title", children: t("confirmRemoveInstance") }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "newapi-modal-body", children: `${t("confirmRemoveInstanceBody")} ${instances[confirmRemoveIndex]?.displayName.trim() || instances[confirmRemoveIndex]?.id || ""}` }),
