    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("legend", { className: "newapi-instance-head", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "newapi-instance-actions", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          ...
          children: confirmRemove ? t("confirmRemove") : t("removeInstance")
        }
      ) })
    ] }),
...
function NewApiSection(props) {
  ...
  const pushToast = (text, kind, onUndo) => {
    ...
    setTimeout(() => dismissToast(id), kind === "undo" ? 6e3 : 3500);
  };
  const load = async () => {
    setStatus("loading");
    setErrorText(void 0);
  ...
  const save = async () => {
    ...
    try {
      ...
      setPendingKeys(/* @__PURE__ */ new Map());
      pushToast(`${t("saved")} \xB7 ${t("appliedImmediate")}`, "ok");
    } catch (error) {
      setErrorText(error instanceof Error ? error.message : String(error));
    } finally {
      setBusy(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { "aria-label": t("nav"), children: [
    ...
    toasts.length === 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "newapi-toasts", role: "status", "aria-live": "polite", children: toasts.map((toast) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: `newapi-toast newapi-toast--${toast.kind}`, children: [
