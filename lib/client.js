...
function InstanceEditor(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("fieldset", { className: "newapi-instance", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("legend", { className: "newapi-instance-head", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "newapi-instance-actions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "newapi-linkbutton", disabled: index === 0, onClick: () => {
          onMove(-1);
        }, children: t("moveUp") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "newapi-linkbutton", disabled: index === total - 1, onClick: () => {
          onMove(1);
        }, children: t("moveDown") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "newapi-linkbutton newapi-iconbutton--danger", onClick: onRemove, children: t("removeInstance") })
      ] })
    ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "input",
            {
              ...
              onChange: (event) => {
                patch({ proxyEnabled: event.target.checked });
              }
            }
          ),
          t("proxyToggle")
        ] }),
        draft.proxyEnabled ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            className: "newapi-input",
            type: "text",
...
function serializeInstance(draft) {
  const models = draft.models.map((model) => {
    const id = textOf2(model, "id").trim();
...
function NewApiSection(props) {
  ...
  const moveInstance = (index, direction) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { "aria-label": t("nav"), children: [
    ...
    instances.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "newapi-empty", children: t("noInstances") }) : null,
    instances.map((draft, index) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        InstanceEditor,
        {
          ...
          parseChannelConn,
          onPatch: (patch) => {
            patchInstance(index, patch);
          },
          onPendingKey: (value) => {
            handlePendingKey(index, value);
          },
          onRemove: () => {
        ...
        draft.id === "" ? index : `${draft.id}-${String(index)}`
      );
    }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "newapi-instance-actions", style: { marginTop: 8 }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      "button",
      {
        type: "button",
        className: "newapi-addmodel",
        disabled: busy,
        onClick: () => {
          setInstances((current) => [...current, blankDraft()]);
        },
        children: t("addInstance")
      }
    ) }),
