...
function InstanceEditor(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("fieldset", { className: "newapi-instance", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("legend", { className: "newapi-instance-head", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "newapi-instance-actions", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          type: "button",
...
function NewApiSection(props) {
  ...
  const [trash, setTrash] = (0, import_react2.useState)([]);
  const [trashOpen, setTrashOpen] = (0, import_react2.useState)(false);
  ...
  const [page, setPage] = (0, import_react2.useState)("config");
  const [ui, setUi] = (0, import_react2.useState)({ undoMs: 7e3, undoEnabled: true, soundEnabled: true });
  const [confirmRemoveIndex, setConfirmRemoveIndex] = (0, import_react2.useState)(-1);
  const [confirmRemoveLeaving, setConfirmRemoveLeaving] = (0, import_react2.useState)(false);
  const [importText, setImportText] = (0, import_react2.useState)("");
  const [importBusy, setImportBusy] = (0, import_react2.useState)(false);
  const [importError, setImportError] = (0, import_react2.useState)(void 0);
  const [saveState, setSaveState] = (0, import_react2.useState)("clean");
  const autoSaveTimer = (0, import_react2.useRef)(void 0);
  const [toasts, setToasts] = (0, import_react2.useState)([]);
  const toastSeq = (0, import_react2.useRef)(0);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { "aria-label": t("nav"), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "newapi-toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "newapi-toolbar-tabs", role: "tablist", "aria-label": t("nav"), children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "newapi-toolbar-ico newapi-toolbar-ico--cards", "aria-hidden": true }),
              t("configPage")
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "newapi-toolbar-ico newapi-toolbar-ico--gear", "aria-hidden": true }),
              t("settingsPage")
            ]
          }
        )
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "newapi-toolbar-right", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", { className: "newapi-trashbtn-ico", viewBox: "0 0 16 16", fill: "none", "aria-hidden": true, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M2.5 4h11M6.5 4V2.5h3V4M4 4l.7 9a1 1 0 001 .9h4.6a1 1 0 001-.9L12 4M6.5 6.8v4.4M9.5 6.8v4.4", stroke: "currentColor", strokeWidth: "1.3", strokeLinecap: "round", strokeLinejoin: "round" }) }),
              trash.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "newapi-trashbtn-badge", children: String(trash.length) }) : null
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: `newapi-savestate${saveState === "clean" ? " newapi-savestate--hidden" : ""} newapi-savestate--${saveState}`, children: saveState === "dirty" ? t("unsaved") : saveState === "saving" ? t("saving") : t("savedLive") }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: `newapi-page newapi-page--${page}`, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "newapi-panel", children: [
        ...
        instances.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "newapi-empty", children: t("noInstances") }) : activeDraft === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          InstanceEditor,
          {
            ...
            draft: activeDraft,
            ...activeCredential === void 0 ? { keyLocked: false } : {
              ...activeCredential.configured === void 0 ? {} : { keyConfigured: activeCredential.configured },
            ...
            onPendingKey: (ref, value) => {
              handlePendingKey(safeActiveIndex, ref, value);
            },
            onRequestRemove: () => {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "newapi-panel", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "newapi-settings-block", "aria-label": t("settingsPage"), children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "newapi-catalog-head", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "newapi-catalog-title", children: t("settingsUndo") }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "button",
            {
              type: "button",
              role: "switch",
              "aria-checked": ui.undoEnabled,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { className: "newapi-proxylabel", children: [
          t("settingsUndoMs"),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "input",
            {
              ...
              onChange: (event) => {
                ...
                setUi((current) => ({ ...current, undoMs: Math.min(6e4, Math.max(1e3, ms)) }));
                markDirty();
              }
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "newapi-catalog-head", style: { marginTop: 18 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "newapi-catalog-title", children: t("settingsSound") }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "button",
            {
              type: "button",
              role: "switch",
              "aria-checked": ui.soundEnabled,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "newapi-catalog-head", style: { marginTop: 18 }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "newapi-catalog-title", children: t("importChannelConn") }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "newapi-hint", children: t("importHint") }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "textarea",
          {
            className: "newapi-input",
        ...
        importError === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "newapi-error", children: importError }),
    ...
    !trashOpen ? null : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "div",
          {
            className: "newapi-modal newapi-modal--trash",
            role: "dialog",
            "aria-modal": "true",
            "aria-label": t("trashTitle"),
            onClick: (event) => {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { className: "newapi-modal-title", children: t("trashTitle") }),
              trash.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "newapi-modal-body newapi-empty", children: t("trashEmpty") }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", { className: "newapi-trash-list", children: trash.map((draft, index) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { className: "newapi-trash-item", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "newapi-trash-item-name", children: draft.displayName.trim().length > 0 ? draft.displayName : draft.id }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "newapi-trash-item-sub", children: draft.baseURL.trim().length > 0 ? draft.baseURL : t("noBaseUrl") }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "newapi-trash-item-actions", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                    "button",
                    {
                      type: "button",
                      className: "newapi-button",
                      onClick: () => {
                        restoreInstance(draft, instances.length);
                      },
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                    ...
                    {
                      type: "button",
                      className: "newapi-button newapi-button--danger",
                      onClick: () => {
              ...
              ] }, `${draft.id}-${String(index)}`)) }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "newapi-modal-actions", children: [
                trash.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                  "button",
                  {
                    type: "button",
                    className: "newapi-button newapi-button--danger",
    ...
    confirmRemoveIndex < 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { className: "newapi-modal-title", children: t("trashPermanentTitle") }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "newapi-modal-body", children: confirmRemoveIndex === -2 ? t("trashClearBody") : `${t("trashPermanentBody")} ${trash[confirmRemoveIndex]?.displayName.trim() || trash[confirmRemoveIndex]?.id || ""}` }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "newapi-modal-actions", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                  "button",
                  {
    ...
    toasts.length === 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "newapi-toasts", role: "status", "aria-live": "polite", children: toasts.map((toast) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: `newapi-toast newapi-toast--${toast.kind}${toast.leaving === true ? " newapi-toast--leaving" : ""}`, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "newapi-toast-text", children: toast.text }),
      toast.onUndo === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "button",
        {
          type: "button",
