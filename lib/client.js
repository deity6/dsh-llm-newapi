...
function NewApiSection(props) {
  ...
  const removeInstance = (index) => {
    ...
    if (removedId !== void 0 && removedId === activeId) {
      setActiveId(void 0);
    }
  };
  const addInstance = () => {
  ...
  const activeIndex = instances.length === 0 ? -1 : Math.max(0, instances.findIndex((d) => d.id === activeId));
  const activeDraft = activeIndex >= 0 ? instances[activeIndex] : void 0;
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { "aria-label": t("nav"), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "newapi-tabs", role: "tablist", "aria-label": t("instanceTabs"), children: [
      instances.map((draft, index) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          ...
          draft.id === "" ? `blank-${String(index)}` : draft.id
        );
      }),
    ...
    instances.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "newapi-empty", children: t("noInstances") }) : activeDraft === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      InstanceEditor,
      {
        ...
        parseChannelConn,
        onPatch: (patch) => {
          patchInstance(activeIndex, patch);
        },
        onPendingKey: (value) => {
          handlePendingKey(activeIndex, value);
        },
        onRemove: () => {
          removeInstance(activeIndex);
        }
      },
      activeDraft.id === "" ? `blank-${String(activeIndex)}` : activeDraft.id
    ),
